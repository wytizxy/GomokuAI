 ...
 * @author DELL
 */
public class Gomoku111  extends JFrame{

	
	ImageIcon map;				//棋盘背景位图
	ImageIcon blackchess;		//黑子位图
	ImageIcon whitechess;		//白子位图
	private Panel cp;				//棋盘
	private JPanel east;
	private JPanel west;
	...
	private JMenuItem[] menuitem2={new JMenuItem("forbid"),new JMenuItem("pve"),new JMenuItem("pvp")};
	...
	//构造函数
	void Gomoku111() {
		setTitle("Gomoku by ZXY ZYB ZTC");
	...
	//初始化与默认值
 	private void init() 
 	{
		...
		cp=new Panel(map,blackchess,whitechess);
		...
		public void actionPerformed(ActionEvent e) 
		{
      		...
      		if(actionCommand.equals("Rollback")){ 		//悔棋
        		...
        		int sel = JOptionPane.showOptionDialog(
      			...
      			haveai=true;
      			Object[] options = { "person first", "computer first" };
        		int sel = JOptionPane.showOptionDialog(
          				null, "choose：", "first",
          				JOptionPane.DEFAULT_OPTION,
          				JOptionPane.QUESTION_MESSAGE, null,
